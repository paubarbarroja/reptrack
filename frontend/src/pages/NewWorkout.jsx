  ...
  return (
    <div>
      ...
      <form onSubmit={onSubmit} className="card">
        ...
        <h3>Series</h3>
        <p className="hint">
          Añade una fila por cada serie que hagas: elige el ejercicio del catálogo (el mismo listado
          para todos los usuarios), el peso usado, las repeticiones que completaste y, si quieres, el
          RPE (lo duro que te resultó, del 1 al 10).
        </p>
        {exercises.length === 0 && (
          <p className="hint">No se ha podido cargar el catálogo de ejercicios. Inténtalo de nuevo más tarde.</p>
        )}
        {sets.map((s, i) => (
